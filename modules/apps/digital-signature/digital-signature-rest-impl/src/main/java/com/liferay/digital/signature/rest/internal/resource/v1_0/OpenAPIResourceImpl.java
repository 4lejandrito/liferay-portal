...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Sends DocuSign-style digital-signing envelopes, attaches documents and recipients, and returns signing-view URLs for each recipient.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.digital.signature.rest.client', and version '1.0.35'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:1338891938