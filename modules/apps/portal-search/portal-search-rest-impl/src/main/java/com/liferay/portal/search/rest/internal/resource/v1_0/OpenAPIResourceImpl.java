...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Performs portal-wide full-text search across indexed content (assets, articles, documents, users, sites) with filtering, sorting, and faceting.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.portal.search.rest.client', and version '1.0.28'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:-262746263