...
public class OAuth2ResourceIndicatorsTest extends BaseClientTestCase {
	...
	@Test
	public void testCodeGrantWithMalformedResourceReturnsInvalidTarget()
		throws Exception {
		...
		tokenFormData.add("code", _getAuthorizationCode());
		tokenFormData.add("grant_type", "authorization_code");
		tokenFormData.add("resource", "https://mcp.example.com/#fragment");
		...
		Assert.assertEquals(400, tokenResponse.getStatus());
		Assert.assertEquals("invalid_target", parseError(tokenResponse));
	}
	...
	private String _getAuthorizationCode() throws Exception {
