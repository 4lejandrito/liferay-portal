...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Manages outbound notification templates and inspects the queue of notifications waiting to be delivered, including resend.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.notification.rest.client', and version '1.0.40'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:1076905523