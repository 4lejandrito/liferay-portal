...
public interface ToolSummaryResource {
	...
	public HttpInvoker.HttpResponse getToolSummariesPageHttpResponse(
			String intent, String search)
		throws Exception;
	...
	public static class ToolSummaryResourceImpl implements ToolSummaryResource {
		...
		public Page<ToolSummary> getToolSummariesPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getToolSummariesPageHttpResponse(intent, search);
		...
		public HttpInvoker.HttpResponse getToolSummariesPageHttpResponse(
			...
			if (intent != null) {
				httpInvoker.parameter("intent", String.valueOf(intent));
			}
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/mcp-server/v1.0/tool-summaries");
...
// LIFERAY-REST-BUILDER-HASH:1020789612