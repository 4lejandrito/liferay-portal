...
/**
 * Provides the local service interface for ChannelScopeRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ChannelScopeRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ChannelScopeRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChannelScopeRelLocalServiceUtil} to access the channel scope rel local service. Add custom service methods to <code>com.liferay.multichannel.service.impl.ChannelScopeRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
