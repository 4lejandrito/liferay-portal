...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Defines structured data definitions, layouts, and rendering contexts that drive Liferay's structured-content forms and the editing UI for custom fields.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.data.engine.rest.client', and version '3.0.40'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Data Engine", version = "v2.0")
)
@Path("/v2.0")
...
// LIFERAY-REST-BUILDER-HASH:747237206