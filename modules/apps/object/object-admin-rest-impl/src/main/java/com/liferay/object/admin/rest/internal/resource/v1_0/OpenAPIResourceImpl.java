...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Defines Liferay Objects, including object definitions, fields, field settings and validations, actions, layouts, folders, relationships, and views.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.object.admin.rest.client', and version '1.0.87'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Object", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:952686781