 ...
 */
@Component(
	property = "resource.locator.key=/object/v1.0/ObjectEntry",
	service = ObjectEntryResource.Factory.class
)
@Generated("")
public class ObjectEntryResourceFactoryImpl
	...
	public ObjectEntryResource.Builder create() {
		return new ObjectEntryResource.Builder() {
			...
			public ObjectEntryResource build() {
				...
				Function<InvocationHandler, ObjectEntryResource>
					objectEntryResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_objectEntryResourceProxyProviderFunction;

				return objectEntryResourceProxyProviderFunction.apply(
	...
	private Object _invoke(
		...
		objectEntryResource.setContextHttpServletResponse(httpServletResponse);
		objectEntryResource.setContextUriInfo(uriInfo);
		objectEntryResource.setContextUser(user);
		objectEntryResource.setExpressionConvert(_expressionConvert);
		objectEntryResource.setFilterParserProvider(_filterParserProvider);
		objectEntryResource.setGroupLocalService(_groupLocalService);
		objectEntryResource.setResourceActionLocalService(
			_resourceActionLocalService);
		objectEntryResource.setResourcePermissionLocalService(
			_resourcePermissionLocalService);
		objectEntryResource.setRoleLocalService(_roleLocalService);
		objectEntryResource.setSortParserProvider(_sortParserProvider);
