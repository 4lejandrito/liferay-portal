...
public class ObjectDefinitionModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"restContextPath", Types.VARCHAR}, {"storageType", Types.VARCHAR},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("restContextPath", Types.VARCHAR);
	...
	public Object clone() {
		...
		objectDefinitionImpl.setRESTContextPath(getRESTContextPath());
	...
	public ObjectDefinition cloneWithOriginalValues() {
		...
		objectDefinitionImpl.setRESTContextPath(
			this.<String>getColumnOriginalValue("restContextPath"));
	...
	public CacheModel<ObjectDefinition> toCacheModel() {
		...
		objectDefinitionCacheModel.restContextPath = getRESTContextPath();

		String restContextPath = objectDefinitionCacheModel.restContextPath;

		if ((restContextPath != null) && (restContextPath.length() == 0)) {
			objectDefinitionCacheModel.restContextPath = null;
		}
	...
	private String _restContextPath;
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("restContextPath", _restContextPath);
	...
	static {
		...
		columnBitmasks.put("restContextPath", 1073741824L);
