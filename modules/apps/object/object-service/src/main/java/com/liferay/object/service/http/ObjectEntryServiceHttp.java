...
public class ObjectEntryServiceHttp {
	...
	public static void subscribeObjectEntry(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_subscribeObjectEntryParameterTypes19);
	...
	public static void unsubscribeObjectEntry(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_unsubscribeObjectEntryParameterTypes20);
	...
	private static final Class<?>[] _subscribeObjectEntryParameterTypes19 =
		new Class[] {long.class, long.class, long.class};
	private static final Class<?>[] _unsubscribeObjectEntryParameterTypes20 =
