...
import com.liferay.site.item.selector.web.internal.display.context.ContentRepositoriesItemSelectorViewDisplayContext;
...
public class DepotItemSelectorView
	...
	public void renderHTML(
		...
		ContentRepositoriesItemSelectorViewDisplayContext
			contentRepositoriesItemSelectorViewDisplayContext =
				new ContentRepositoriesItemSelectorViewDisplayContext(
	...
	@Reference(
		target = "(group.search.provider.type=" + GroupConstants.TYPE_DEPOT + ")"
	)
