...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Defines and runs bulk actions on selections of objects, supports preview before applying, and exposes assignable selection actions like assign, copy, default-permission, and structure-default-workflow.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.bulk.rest.client', and version '3.0.41'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:307970614