...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Configures the Liferay Analytics integration, covering channels, commerce channels, contact data sources, account groups, organizations, user groups, and tracker settings.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.analytics.settings.rest.client', and version '1.0.35'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Liferay Analytics Settings", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:146407220