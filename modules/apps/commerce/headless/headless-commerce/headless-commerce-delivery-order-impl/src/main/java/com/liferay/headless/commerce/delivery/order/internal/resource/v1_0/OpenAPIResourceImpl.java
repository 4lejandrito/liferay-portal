...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Storefront order endpoints for shoppers to view their placed orders, items, comments, addresses, attachments, and order-status transitions.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.headless.commerce.delivery.order.client', and version '1.0.35'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Headless Delivery Commerce Order API", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:-1928451865