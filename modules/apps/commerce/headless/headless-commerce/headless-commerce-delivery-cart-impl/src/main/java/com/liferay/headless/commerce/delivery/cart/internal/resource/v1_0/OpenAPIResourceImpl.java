...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Storefront cart endpoints for shoppers to add items, update quantities, apply coupons, attach addresses, and transition the cart toward checkout.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.headless.commerce.delivery.cart.client', and version '4.0.55'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Headless Delivery Commerce Cart API", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:-1637463552