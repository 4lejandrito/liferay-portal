...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Headless access to Liferay CMS asset permissions and asset usage cross-references.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.headless.cms.client', and version '1.0.7'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Liferay Headless CMS", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:-229080576