...
public abstract class BaseLanguageOverrideResourceImpl
	implements EntityModelResource, LanguageOverrideResource,
			   VulcanBatchEngineTaskItemDelegate<LanguageOverride> {
	...
	@io.swagger.v3.oas.annotations.Operation(
		extensions = @io.swagger.v3.oas.annotations.extensions.Extension(name = "feature-flag", properties = @io.swagger.v3.oas.annotations.extensions.ExtensionProperty(name = "key", value = "LPD-49852"))
	)
	...
	@jakarta.ws.rs.Path(
		"/language-overrides/by-external-reference-code/{externalReferenceCode}"
	)
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/language-overrides")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Path("/language-overrides/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postLanguageOverrideBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				LanguageOverride.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/language-overrides/export-batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postLanguageOverridesPageExportBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.ws.rs.QueryParam("search")
			String search,
			@jakarta.ws.rs.core.Context com.liferay.portal.kernel.search.Sort[]
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				LanguageOverride.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	...
	public void create(
			Collection<LanguageOverride> languageOverrides,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<LanguageOverride, LanguageOverride, Exception>
			languageOverrideUnsafeFunction = null;
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "UPSERT")) {
			...
			if (StringUtil.equalsIgnoreCase(updateStrategy, "UPDATE")) {
				languageOverrideUnsafeFunction = languageOverride -> {
					LanguageOverride persistedLanguageOverride = null;

					persistedLanguageOverride =
						putLanguageOverrideByExternalReferenceCode(
							languageOverride.getExternalReferenceCode(),
							languageOverride);

					return persistedLanguageOverride;
				};
			}
		}

		if (languageOverrideUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for LanguageOverride");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				languageOverrides, languageOverrideUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				languageOverrides, languageOverrideUnsafeFunction::apply);
		}
		else {
			for (LanguageOverride languageOverride : languageOverrides) {
				languageOverrideUnsafeFunction.apply(languageOverride);
			}
		}
	}
	...
	@Override
	public Page<LanguageOverride> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<LanguageOverride>,
			 UnsafeConsumer<LanguageOverride, Exception>, Exception>
	...
	protected String getApplicationPath() {
		return "headless-admin-language-override";
	}
...
// LIFERAY-REST-BUILDER-HASH:-1320731783