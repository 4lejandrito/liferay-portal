...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Administers site-level page templates, layouts, fragments, navigation menus, theme settings, and site analytics configuration.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.headless.admin.site.client', and version '1.0.30'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Liferay Admin Sites Headless API", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:24838400