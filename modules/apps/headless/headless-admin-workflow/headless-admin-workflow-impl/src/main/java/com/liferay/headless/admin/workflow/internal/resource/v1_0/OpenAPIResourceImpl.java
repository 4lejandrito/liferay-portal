...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Manages workflow definitions, deploys them, and links definitions to content; inspects workflow nodes, transitions, and reviewers.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.headless.admin.workflow.client', and version '4.0.48'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Headless Admin Workflow", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:1304555540