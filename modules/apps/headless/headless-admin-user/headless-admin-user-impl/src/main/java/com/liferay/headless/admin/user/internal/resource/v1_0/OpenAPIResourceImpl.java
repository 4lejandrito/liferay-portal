...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Manages user accounts, account groups, account roles, account memberships, organizations, organization roles, user groups, and asset-library role permissions.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.headless.admin.user.client', and version '4.0.85'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Headless Admin User", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:27648027