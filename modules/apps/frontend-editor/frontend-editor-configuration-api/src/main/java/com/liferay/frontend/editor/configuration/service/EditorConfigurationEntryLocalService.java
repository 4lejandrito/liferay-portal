...
/**
 * Provides the local service interface for EditorConfigurationEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EditorConfigurationEntryLocalServiceUtil
...
public interface EditorConfigurationEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EditorConfigurationEntryLocalServiceUtil} to access the editor configuration entry local service. Add custom service methods to {@link com.liferay.frontend.editor.configuration.service.impl.EditorConfigurationEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
