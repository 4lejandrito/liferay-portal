...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Issues and validates CAPTCHA challenges to gate sensitive operations from anonymous users.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.captcha.rest.client', and version '1.0.17'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:-1070824664