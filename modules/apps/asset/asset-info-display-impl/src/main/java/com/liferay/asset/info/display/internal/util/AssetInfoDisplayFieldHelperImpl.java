 ...
 */
@Component(immediate = true, service = AssetInfoDisplayFieldHelper.class)
public class AssetInfoDisplayFieldHelperImpl
	implements AssetInfoDisplayFieldHelper {

	public Map<String, Object> getAssetInfoDisplayFieldsValues(
