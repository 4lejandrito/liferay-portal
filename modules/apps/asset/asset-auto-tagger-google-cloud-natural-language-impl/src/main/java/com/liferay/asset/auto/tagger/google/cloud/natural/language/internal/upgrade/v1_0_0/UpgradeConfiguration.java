...
package com.liferay.asset.auto.tagger.google.cloud.natural.language.internal.upgrade.v1_0_0;
	...
	protected void doUpgrade() throws Exception {
		_upgradeConfigurations(
			StringBundler.concat(
				"com.liferay.document.library.asset.auto.tagger.google.cloud.",
				"natural.language.internal.configuration.",
				"GCloudNaturalLanguageAssetAutoTagProviderCompany",
				"Configuration"),
			DLFileEntryConstants.getClassName());

		_upgradeConfigurations(
			StringBundler.concat(
				"com.liferay.journal.asset.auto.tagger.google.cloud.natural.",
