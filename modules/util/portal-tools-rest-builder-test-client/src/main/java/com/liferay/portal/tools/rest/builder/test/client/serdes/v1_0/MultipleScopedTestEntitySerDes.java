...
public class MultipleScopedTestEntitySerDes {
	...
	public static String toJSON(
		...
		if (multipleScopedTestEntity.getAssetLibraryId() != null) {
			...
			sb.append(multipleScopedTestEntity.getAssetLibraryId());
		}
	...
	public static Map<String, String> toMap(
		...
		if (multipleScopedTestEntity.getAssetLibraryId() == null) {
			...
			map.put(
				"assetLibraryId",
				String.valueOf(multipleScopedTestEntity.getAssetLibraryId()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "assetLibraryId")) {
				if (jsonParserFieldValue != null) {
					multipleScopedTestEntity.setAssetLibraryId(
