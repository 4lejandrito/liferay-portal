...
public abstract class BaseMultipleScopedTestEntityResourceTestCase {
		...
		assertHttpResponseStatusCode(
			...
			multipleScopedTestEntityResource.
				deleteAssetLibraryMultipleScopedTestEntityByExternalReferenceCodeHttpResponse(
					multipleScopedTestEntity.getAssetLibraryId(),
		...
		MultipleScopedTestEntity getMultipleScopedTestEntity =
			multipleScopedTestEntityResource.
				getAssetLibraryMultipleScopedTestEntityByExternalReferenceCode(
					postMultipleScopedTestEntity.getAssetLibraryId(),
	...
	public void testPatchAssetLibraryMultipleScopedTestEntityByExternalReferenceCode()
		...
		MultipleScopedTestEntity getMultipleScopedTestEntity =
			multipleScopedTestEntityResource.
				getAssetLibraryMultipleScopedTestEntityByExternalReferenceCode(
					patchMultipleScopedTestEntity.getAssetLibraryId(),
	...
	public void testPutAssetLibraryMultipleScopedTestEntityByExternalReferenceCode()
		...
		MultipleScopedTestEntity getMultipleScopedTestEntity =
			multipleScopedTestEntityResource.
				getAssetLibraryMultipleScopedTestEntityByExternalReferenceCode(
					putMultipleScopedTestEntity.getAssetLibraryId(),
		...
		putMultipleScopedTestEntity =
			multipleScopedTestEntityResource.
				putAssetLibraryMultipleScopedTestEntityByExternalReferenceCode(
					newMultipleScopedTestEntity.getAssetLibraryId(),
	...
	protected void assertValid(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("assetLibraryId", additionalAssertFieldName)) {
				if (multipleScopedTestEntity.getAssetLibraryId() == null) {
					valid = false;
				}
	...
	protected boolean equals(
		...
		if (!Objects.equals(
				multipleScopedTestEntity1.getSiteId(),
				multipleScopedTestEntity2.getSiteId())) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("assetLibraryId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						multipleScopedTestEntity1.getAssetLibraryId(),
						multipleScopedTestEntity2.getAssetLibraryId())) {
	...
	protected MultipleScopedTestEntity
		...
		randomIrrelevantMultipleScopedTestEntity.setAssetLibraryId(
