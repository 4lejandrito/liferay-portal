...
public class ResourceOpenAPIParser {
	...
	public static String getMethodAnnotations(
		...
		if (featureFlag != null) {
			operationAttributes.add(
				_getFeatureFlagExtensionAttribute(featureFlag));
