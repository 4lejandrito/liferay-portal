...
public class FreeMarkerTool {
	...
	public boolean isParameterNameSchemaRelated(
		...
		String formattedPath = TextFormatter.format(path, TextFormatter.K);
		...
		if (StringUtil.equals(
			...
			(StringUtil.equals(parameterSchemaName, pathSegments[1]) &&
			 ((pathSegments.length <= 3) ||
			  !StringUtil.startsWith(pathSegments[2], "by-")) &&
			 (!formattedPath.contains(formattedSchemaNamePlural) ||
			  !formattedPath.contains(formattedSchemaNameSingular)))) {
