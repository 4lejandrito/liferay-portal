...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Tunes search results with Search Blueprints (SXP elements, configurations, conditions); evaluates the resulting search query before deployment.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.search.experiences.rest.client', and version '3.0.42'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:1210279378