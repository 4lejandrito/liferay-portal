...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Asset traffic and engagement metrics for Liferay Analytics Reports, including histograms, devices, referrers, and other audience data per asset.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.analytics.reports.rest.client', and version '1.2.7'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Liferay Analytics Reports", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:813822957