...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Workflow analytics endpoints for assignee, process, instance, task, and SLA metrics; triggers reindexing of workflow data.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.portal.workflow.metrics.rest.client', and version '3.0.47'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:1856127826