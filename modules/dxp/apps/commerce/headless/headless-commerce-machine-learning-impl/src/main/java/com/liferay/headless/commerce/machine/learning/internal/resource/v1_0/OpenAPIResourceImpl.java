...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Commerce machine-learning predictions including account forecasts, account-category forecasts, frequent-pattern recommendations, and time-series order data.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.headless.commerce.machine.learning.client', and version '1.0.33'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Liferay Commerce ML API", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:-1070748882