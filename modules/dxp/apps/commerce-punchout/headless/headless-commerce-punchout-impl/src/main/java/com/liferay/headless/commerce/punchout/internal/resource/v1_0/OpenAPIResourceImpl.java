...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Initiates B2B punch-out sessions where buyers shop on a Liferay catalog and return their cart selection to a procurement system.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Liferay Headless Commerce Punch Out", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:1213501014